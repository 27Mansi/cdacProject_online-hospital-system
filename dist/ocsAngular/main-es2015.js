...
let AfterloginComponent = class AfterloginComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AppointmentComponent = class AppointmentComponent {
    ...
    addAppointment() {
        ...
        let obsreg = this.dataService.addAppDetails(this.formdata.value);
...
let ChangepasswordComponent = class ChangepasswordComponent {
    ...
    updatepass(mypassform) {
        console.log(this.user);
        let obsres = this.service.UpdatePass(this.user);
...
let DeleteComponent = class DeleteComponent {
    ...
    ngOnInit() {
        this.route.paramMap.subscribe((result) => {
            ...
            console.log(No);
            let observableResult = this.dataService.deleteDocById(No);
            observableResult.subscribe((records) => {
                console.log(records);
                this.router.navigate(['listofdoctors']);
            });
        });
    }
};
...
let DoctorComponent = class DoctorComponent {
    ...
    addDoctor() {
        ...
        //this.user=registerfrom.form.value;
        console.log(this.formdata.value);
        let obsreg = this.dataService.addDocDetails(this.formdata.value);
        obsreg.subscribe((res) => {
            this.data = res;
...
let EmitterserviceService = class EmitterserviceService {
    constructor() {
...
let ListofappointmentsComponent = class ListofappointmentsComponent {
    constructor(route, router, dataService) {
        this.route = route;
        this.router = router;
        this.dataService = dataService;
    ...
    ngOnInit() {
        let obsRes = this.dataService.getAllApp();
        obsRes.subscribe((result) => {
            console.log(result);
            this.app = result;
        });
...
ListofappointmentsComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"] }
];
...
let ListofdoctorsComponent = class ListofdoctorsComponent {
...
ListofdoctorsComponent.ctorParameters = () => [
...
let ListofpatientsComponent = class ListofpatientsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PatientComponent = class PatientComponent {
    ...
    addPatient() {
        ...
        //this.user=registerfrom.form.value;
        console.log(this.formdata.value);
        let obsreg = this.dataService.addPatDetails(this.formdata.value);
        obsreg.subscribe((res) => {
            this.data = res;
            if (this.data.role == "PATIENT") {
                console.log("inside iffffffff");
...
let ReceptionistComponent = class ReceptionistComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SigninComponent = class SigninComponent {
    constructor(emtService, authService, router) {
    ...
    SignIn(loginform) {
        ...
        console.log(logincredentials);
        let isuservalid = this.authService.LogIn(logincredentials);
...
let SignupComponent = class SignupComponent {
    ...
    // password:'';
    // role='';
    constructor(emtService, authService, router, dataService) {
        this.emtService = emtService;
        this.authService = authService;
        this.router = router;
        this.dataService = dataService;
